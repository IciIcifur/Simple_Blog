...
describe('PostComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [PostComponent], providers: [appConfig.providers]
    }).compileComponents();
  ...
  it('empty form should be invalid', () => {
    ...
    const formValueExists = fixture.componentInstance.newPostForm.value.content === '' || fixture.componentInstance.newPostForm.value.title === '';
